 ...
 * @version 1.0
 */
public class CuentasxCobrar_Reportes_Canceladas {
	...
	/**
	 * Constructor de la clase. Genera el reporte y lo
	 * envia a la impresora.
	 *
	 */
	public CuentasxCobrar_Reportes_Canceladas() {
		...
		try {
			...
			for(int i=0, espacio=0; i < datos.length; i++) {
				...
				if(!datos[i][8].equals("")) {
					...
					// Fecha Cancelacion
					impresion.drawString(datos[i][7], 485, 150+(13*espacio));
					// Valor Cancelado
