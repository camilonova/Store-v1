 ...
 * @version 1.5
 */
public class Client_ModeloTabla extends AbstractTableModel {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		Client_DatabaseProxy DB = Client_DatabaseProxy.getInstancia();
		datos[rowIndex][columnIndex] = DB.updateCliente(ID, columnIndex, (String) aValue);
